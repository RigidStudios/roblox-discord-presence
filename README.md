...
## Installation
* The plugin is available [here (source)](https://github.com/RigidStudios/roblox-discord-presence/releases/tag/v0.1.2-alpha), and [here (direct plugin)](https://www.roblox.com/library/6478572909/DRPC).
* The server is slightly more complicated to set up:
   ...
   * Next, download the [source](https://github.com/RigidStudios/roblox-discord-presence/releases/tag/v0.1.2-alpha), extract the files from the zip into a new folder.
